...
pyrogram.utils.MIN_CHANNEL_ID = -1002515503407
    ...
    async def start(self):
        ...
        if FORCE_SUB_CHANNEL:
            try:
                ...
                self.LOGGER(__name__).info("\nBot Stopped. https://t.me/XploitdroidBots For Support")
                sys.exit()
        ...
        try:
            ...
            self.LOGGER(__name__).info("\nBot Stopped. Join https://t.me/XploitdroidBots For Support")
            sys.exit()

        self.set_parse_mode(ParseMode.HTML)
        self.LOGGER(__name__).info(f"Bot Running...!\n\nCreated By \nhttps://t.me/XploitBots")
        self.LOGGER(__name__).info(f"""ミ💖 Xploitdroid Bots 💖彡""")
